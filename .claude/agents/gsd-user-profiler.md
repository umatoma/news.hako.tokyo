...
<reference>
@/Users/tokahana/workspaces/news.hako.tokyo/.claude/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `/Users/tokahana/workspaces/news.hako.tokyo/.claude/get-shit-done/references/user-profiling.md` to load:
