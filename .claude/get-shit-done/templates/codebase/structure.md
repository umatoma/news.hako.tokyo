...
- Usage: Reference from command with `@/Users/tokahana/workspaces/news.hako.tokyo/.claude/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to /Users/tokahana/workspaces/news.hako.tokyo/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /Users/tokahana/workspaces/news.hako.tokyo/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
