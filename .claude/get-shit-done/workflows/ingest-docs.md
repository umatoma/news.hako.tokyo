...
```bash
INIT=$(node "/Users/tokahana/workspaces/news.hako.tokyo/.claude/get-shit-done/bin/gsd-tools.cjs" init ingest-docs)
...
```bash
node "/Users/tokahana/workspaces/news.hako.tokyo/.claude/get-shit-done/bin/gsd-tools.cjs" commit \
