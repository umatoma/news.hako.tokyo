...
- **Global scope**: `/Users/tokahana/workspaces/news.hako.tokyo/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/tokahana/workspaces/news.hako.tokyo/.claude/notes/`)
...
2. Glob `/Users/tokahana/workspaces/news.hako.tokyo/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/Users/tokahana/workspaces/news.hako.tokyo/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/tokahana/workspaces/news.hako.tokyo/.claude/notes/` — works in any directory
