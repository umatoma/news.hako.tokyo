...
```
Agent(
  prompt="Read /Users/tokahana/workspaces/news.hako.tokyo/.claude/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `/Users/tokahana/workspaces/news.hako.tokyo/.claude/get-shit-done/templates/SECURITY.md`
