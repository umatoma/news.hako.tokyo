...
```bash
INIT=$(node "/Users/tokahana/workspaces/news.hako.tokyo/.claude/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @/Users/tokahana/workspaces/news.hako.tokyo/.claude/get-shit-done/templates/spec.md.
