...
<required_reading>
@/Users/tokahana/workspaces/news.hako.tokyo/.claude/get-shit-done/references/domain-probes.md
@/Users/tokahana/workspaces/news.hako.tokyo/.claude/get-shit-done/references/gate-prompts.md
@/Users/tokahana/workspaces/news.hako.tokyo/.claude/get-shit-done/references/universal-anti-patterns.md
</required_reading>
...
if [ -f "/Users/tokahana/workspaces/news.hako.tokyo/.claude/get-shit-done/USER-PROFILE.md" ]; then
  ADVISOR_MODE=true
else
  ADVISOR_MODE=false
fi
...
Read `@/Users/tokahana/workspaces/news.hako.tokyo/.claude/get-shit-done/references/scout-codebase.md` — it contains the phase-type→map selection table, single-read rule, no-maps fallback, and `<codebase_context>` output schema. Then execute:
