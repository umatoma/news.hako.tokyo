...
INSTALL_JS_GLOBAL="/Users/tokahana/workspaces/news.hako.tokyo/.claude/get-shit-done/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node /Users/tokahana/workspaces/news.hako.tokyo/.claude/get-shit-done/bin/install.js --global --<runtime>
```
Then exit.
